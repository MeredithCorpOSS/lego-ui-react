...
class Dropdown extends React.Component {
  ...
  render() {
    ...
    let {dropdownClassNames, dropdownListClassNames} = this.getCssClasses(props, state);
    ...
    return (
      <div className={dropdownClassNames}>
        <Button
          ...
          onClick={this.onOpen}
        />
        <div className={dropdownListClassNames} aria-labelledby={this.id} onClick={this.onOpen} >
          {props.child}
        </div>
      </div>
    )
